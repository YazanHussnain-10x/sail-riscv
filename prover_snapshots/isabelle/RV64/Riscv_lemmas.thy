...
lemma liftS_read_reg_tlb48[liftState_simp]:
  "\<lbrakk>read_reg tlb48_ref\<rbrakk>\<^sub>S = read_regS tlb48_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_tlb48[liftState_simp]:
  "\<lbrakk>write_reg tlb48_ref v\<rbrakk>\<^sub>S = write_regS tlb48_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_tlb39[liftState_simp]:
  "\<lbrakk>read_reg tlb39_ref\<rbrakk>\<^sub>S = read_regS tlb39_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_tlb39[liftState_simp]:
  "\<lbrakk>write_reg tlb39_ref v\<rbrakk>\<^sub>S = write_regS tlb39_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)
